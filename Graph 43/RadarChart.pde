// RadarChartScreen.pde
// A class for drawing the radar chart (Monthly or Hourly Flight Counts) screen.
// The boolean flag 'showMonthly' determines which data to use.
