...
/*class EarthScreenDirectory extends Screen {
  ...
  EarthScreenDirectory(Earth earth, Airport airportOrigin, Airport airportDest, Airplane airplane) {
      this.earth = earth;
 ...
 void draw() {
  ...
  earth.update();
<<<<<<< HEAD:Interactive Tracker/Main/EarthScreen.pde
...
=======
>>>>>>> Flight-Tracker:Interactive Tracker/Main/EarthScreenDirectory.pde
